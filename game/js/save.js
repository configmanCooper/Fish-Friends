...
export function load() {
  ...
  return Object.assign(defaults(), data, { settings: Object.assign(defaults().settings, data.settings || {}), inventory: Object.assign(defaults().inventory, data.inventory || {}) });
}
